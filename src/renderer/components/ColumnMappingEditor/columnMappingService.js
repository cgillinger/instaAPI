 ...
 * 
 * UPPDATERAD FÖR ENGELSKA CSV-FORMAT (InstaAPI)
 */
import { readColumnMappings as getStoredMappings, saveColumnMappings as storeColumnMappings } from '../../../utils/webStorageService';

// Standard kolumnmappningar - UPPDATERAD för engelska CSV-format
export const DEFAULT_MAPPINGS = {
  // Metadata (engelska kolumnnamn från nya CSV)
  "Post_ID": "post_id",
  "Instagram_ID": "account_id",
  "Account": "account_username",           // ÄNDRAT: Account → account_username
  "Caption_Preview": "description",        // ÄNDRAT: Caption_Preview istället för Beskrivning
  "Post_Date": "publish_time",            // ÄNDRAT: Post_Date istället för Publiceringstid
  "Media_Type": "post_type",              // ÄNDRAT: Media_Type istället för Inläggstyp
  "Post_URL": "permalink",                // ÄNDRAT: Post_URL istället för Permalänk
  
  // Mätvärden (engelska kolumnnamn)
  "Views": "views",                       // ÄNDRAT: Views istället för Visningar
  "Reach": "post_reach",                  // ÄNDRAT: Reach istället för Räckvidd
  "Likes": "likes",                       // ÄNDRAT: Likes istället för Gilla-markeringar
  "Comments": "comments",                 // ÄNDRAT: Comments istället för Kommentarer
  "Shares": "shares",                     // ÄNDRAT: Shares istället för Delningar
  "Follows": "follows",                   // BEHÅLLS: Follows finns i nya CSV (0 för Reels)
  "Saved": "saves"                        // ÄNDRAT: Saved istället för Sparade objekt
};
...
export const DISPLAY_NAMES = {
  ...
  'account_username': 'Konto (användarnamn)',     // UPPDATERAT för account_username
  'account_name': 'Kontonamn',                    // BEHÅLLS för bakåtkompatibilitet
...
// UPPDATERAD med både engelska och svenska exempel
export const COLUMN_EXAMPLES = {
  "views": ["Views", "Visningar"],
  "post_reach": ["Reach", "Räckvidd"],
  "likes": ["Likes", "Gilla-markeringar"],
  "comments": ["Comments", "Kommentarer"],
  "shares": ["Shares", "Delningar"],
  "follows": ["Follows", "Följer", "Följare"],
  "saves": ["Saved", "Sparade objekt", "Sparade", "Saves"],
  "post_id": ["Post_ID", "Publicerings-id", "Inläggs-ID", "Post ID"],
  "account_id": ["Instagram_ID", "Konto-id", "Konto-ID", "Account ID"],
  "account_username": ["Account", "Kontots användarnamn", "Användarnamn", "Username"],  // NYA exempel
  "account_name": ["Kontonamn", "Account name"],                                        // BEHÅLLS
  "description": ["Caption_Preview", "Beskrivning", "Description"],
  "publish_time": ["Post_Date", "Publiceringstid", "Publish time", "Datum", "Date"],
  "post_type": ["Media_Type", "Inläggstyp", "Typ", "Post type"],
  "permalink": ["Post_URL", "Permalänk", "Länk", "Permalink", "Link"]
};

// Gruppera kolumner för bättre översikt i ColumnMappingEditor
export const COLUMN_GROUPS = {
  'Metadata': ['post_id', 'account_id', 'account_username', 'description', 'publish_time', 'post_type', 'permalink'],
 ...
 * 
 * UPPDATERAD: Hantera account_name fallback till account_username
 */
export function getValue(dataObject, targetField) {
  ...
  // KRITISK FALLBACK: account_name → account_username för nya CSV-format
  if (targetField === 'account_name' && dataObject['account_username'] !== undefined) {
    return dataObject['account_username'];
  }
